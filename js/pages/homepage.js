...
export const initializeProducts = async function() {
    try {
        ...
        renderProducts('.js-new-products-list', latestProducts, 'col-xs-12 col-sm-6 col-md-4 col-lg-2');
        renderProducts('.js-featured-product-list', otherProducts, 'col-xs-12 col-sm-6 col-md-4 col-lg-2');
    } catch (error) {
        console.log(error);
    }
}